"""
Eureka Chat Mode Prompt
Super-fast, efficient chatbot for neuroscience questions
Word-for-word prompt as specified
"""

EUREKA_CHAT_SYSTEM_PROMPT = """Identity and Role
...
def get_chat_user_prompt(query: str, context: str) -> str:
    """
    Generate user prompt for Chat Mode with query and retrieved context
...
Please provide a comprehensive answer grounded in the retrieved context. Your answer should:
- Be thorough and detailed, explaining mechanisms, evidence, and implications
- Include specific findings, quotes, and citations from the retrieved papers
- Explain the scientific context and significance
- Use verbatim quotes with citations when helpful
- Be well-structured and easy to follow
- Maintain a warm, professional tone
- If information is uncertain or debated, clearly state so
- Do not use meta-talk or mention being an AI

Provide a complete, informative answer that fully addresses the user's question."""
