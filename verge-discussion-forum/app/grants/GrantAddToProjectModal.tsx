...
interface GrantAddToProjectModalProps {
  open: boolean;
  onClose: () => void;
  grantId: string;
...
const GrantAddToProjectModal: React.FC<GrantAddToProjectModalProps> = ({
  open,
  onClose,
  grantId,
  onAddToProject,
  ...
  console.log("GrantAddToProjectModal received:", {
    grantId,
    open,
  });
  ...
  const handleSaveWithoutProject = async () => {
    ...
    setError("");
    try {
      await fetch("/api/grants/bookmark", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
      ...
      >
        ...
        <DialogContent sx={{ pt: 2 }}>
          <Typography variant="body2" sx={{ mb: 3, color: "#666" }}>
            Choose how you&apos;d like to save this grant. You can add it to an
            ...
            >
              <CardContent sx={{ p: 2, textAlign: "center" }}>
                ...
                <Typography variant="body2" sx={{ color: "#666", mt: 0.5 }}>
                  Save this grant to your bookmarks without organizing it into a
                  project
                </Typography>
              </CardContent>
            </Card>
          ...
          {!showCreateForm ? (
            ...
            >
              <CardContent sx={{ p: 2, textAlign: "center" }}>
                ...
                <Typography variant="body2" sx={{ color: "#666", mt: 0.5 }}>
                  Create a new project and add this grant to it
                </Typography>
              </CardContent>
            </Card>
          ) : (
...
export default GrantAddToProjectModal;
